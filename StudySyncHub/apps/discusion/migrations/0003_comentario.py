...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ...
        ('discusion', '0002_delete_comentario'),
    ]
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('discusion', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='comentarios', to='discusion.discusion')),
            ],
        ),
    ]
